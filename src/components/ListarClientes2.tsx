...
export default function ListarClientes2() {
  const { clientes, carregando, motos } = useApp();
  ...
  const colunas: GridColDef[] = [
    ...
    {field: 'motos',  headerName: 'Motos', flex: 1,sortable: false,   renderCell: (params) => (
        <div>
            <button
    ...
    { field: 'actions', headerName: 'Ações', flex: 1,  sortable: false, renderCell: (params) => (
        <div>
            <button
  ...
  return (
    <Paper className="m-4" sx={{ width: "auto" , height: "80vh" , backgroundColor: "#f5f5f5"}}>
